...
if (isset($_POST['id_petugas'])) {
    ...
    // Ambil nominal SPP dari database
    ...
    // Cek total pembayaran siswa untuk bulan & tahun yang sama
    ...
    // Jika aman, lanjutkan insert data
    ...
    if ($query) {
        echo '<script>alert("Entri Pembayaran Berhasil"); window.location.href = "index_petugas.php";</script>';
    } else {
                ...
                <form method="post">
                    <table class="table">
                                ...
                                <select name="nisn" id="select-nisn" class="form-select">
                                    ...
                                    while ($siswa = mysqli_fetch_array($p)) {
                                        ...
                                        <option value="<?php echo htmlspecialchars($siswa['nisn']); ?>">
                                            <?php echo htmlspecialchars($siswa['nama']); ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="1">:</td>
                            <td>
                                <input class="form-control" type="number" name="tahun_dibayar" required>
                            </td>
                        </tr>
                        <tr>
                            <td>SPP</td>
