...
<body>
    <div class="container">
        <div class="box blue">
            ...
            <div class="number" id="totalSiswa">Loading...</div>
            <div class="label">Jumlah Siswa</div>
        </div>
        <div class="box green">
            <div class="icon"><i class="fas fa-user-shield"></i></div>
            <div class="number" id="totalPetugas">Loading...</div>
    ...
    <script>
        fetch("get_dashboard_data.php")
            .then(res => res.json())
            .then(data => {
                document.getElementById("totalSiswa").innerText = data.siswa;
                document.getElementById("totalPetugas").innerText = data.petugas;
