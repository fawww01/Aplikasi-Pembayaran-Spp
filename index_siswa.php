...
$user = $_SESSION['siswa']; // Ambil data dari session

// Menentukan nama yang akan ditampilkan
$nama = isset($user['nama']) ? $user['nama'] : $user['nama'];
		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?= ($_GET['page'] ?? '') == 'home_siswa' ? 'active' : '' ?>">
						<a class="sidebar-link" href="index_siswa.php?page=home_siswa">
							<i class="align-middle" data-feather="home"></i> <span class="align-middle">Dashboard</span>
						</a>
					</li>

					<li class="sidebar-item <?= ($_GET['page'] ?? '') == 'history_siswa' ? 'active' : '' ?>">
						<a class="sidebar-link" href="index_siswa.php?page=history_siswa">
		...
		<div class="main">
			<main class="content">
				<div class="container-fluid p-0">
					...
					<?php
					$page = isset($_GET['page']) ? $_GET['page'] : 'home_siswa';
					include $page . '.php';
